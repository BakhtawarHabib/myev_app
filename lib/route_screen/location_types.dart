...
class LocationTypes extends StatefulWidget {
  const LocationTypes({Key? key}) : super(key: key);

  @override
  State<LocationTypes> createState() => _LocationTypesState();
}

class _LocationTypesState extends State<LocationTypes> {
